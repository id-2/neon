...
pub fn handle_migrations(connstr: Url) -> Result<()> {
    ...
    let migrations = [
        Migration::Cluster(include_str!(
            "./migrations/0000-neon_superuser_bypass_rls.sql"
        )),
        Migration::Cluster(include_str!("./migrations/0001-alter_roles.sql")),
        Migration::Cluster(include_str!(
            "./migrations/0002-grant_pg_create_subscription_to_neon_superuser.sql"
        )),
        Migration::Cluster(include_str!(
            "./migrations/0003-grant_pg_monitor_to_neon_superuser.sql"
        )),
        Migration::Cluster(include_str!(
            "./migrations/0004-grant_all_on_tables_to_neon_superuser.sql"
        )),
        Migration::Cluster(include_str!(
            "./migrations/0005-grant_all_on_sequences_to_neon_superuser.sql"
        )),
        Migration::Cluster(include_str!(
        ...
        Migration::Cluster(include_str!(
            "./migrations/0008-revoke_replication_for_previously_allowed_roles.sql"
        )),
        Migration::Cluster(include_str!(
            "./migrations/0009-grant_snapshot_synchronization_funcs_to_neon_superuser.sql"
        )),
        Migration::PerDatabase(include_str!("./migrations/0010-fix-CVE-2024-4317.sql")),
    ];
